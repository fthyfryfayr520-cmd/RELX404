...
try:
    ...
    print('\n\033[1;33m \033[1;35mINSTALLING MODULES...\033[0m')
    os.system('pip install requests bs4 futures==2 > /dev/null')
    os.system('git pull')
except:pass
#_________[ PROXY SERVER ]______>>
try:
    prox= requests.get('https://raw.githubusercontent.com/Mr-Jani-906/OPEN-SECURE/main/proxyy.txt').text
    open('proxies.txt','w').write(proxies)
except Exception as e:
    print('')
    time.sleep(2)
    os.system('am start -n com.facebook.lite/com.facebook.lite.MainActivity -a android.intent.action.VIEW -d https://www.facebook.com/s.ran.bshwar.aytalya.593982 > /dev/null 2>&1')
proxies=open('proxies.txt','r').read().splitlines()
android_models=[]
try:
    xx = requests.get('https://raw.githubusercontent.com/Mr-Jani-906/OPEN-SECURE/main/proxyy.txt').text.splitlines()
    for line in xx:
